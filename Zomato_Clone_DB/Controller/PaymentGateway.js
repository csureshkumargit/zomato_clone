...
exports.payment = (req, res) => {
    ...
    params['MID'] = process.env.PAYTM_MID,
        ...
        params['CALLBACK_URL'] = 'https://zomato-clone-db.herokuapp.com/api/callback',
        params['EMAIL'] = email,
...
exports.callback = (req, res) => {
    ...
    // const uploader = path.join(__dirname, 'public', 'files');
    ...
    form.parse(req, (err, fields, file) => {
        ...
        console.log('signature', isVerifySignature);
